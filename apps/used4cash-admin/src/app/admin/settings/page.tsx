                    ...
                    {THEME_OPTIONS.map((opt) => {
                        ...
                        return (
                            <button
                                ...
                                className={`relative group rounded-2xl overflow-hidden border-2 transition-all duration-200 text-left ${
                                    isSelected
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            <input
                                ...
                                className={`w-full border rounded-lg px-4 py-3 pl-10 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all ${
                                    activeTheme === 'light'
