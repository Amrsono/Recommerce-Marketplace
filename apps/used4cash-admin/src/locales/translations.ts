...
export const translations: Record<Locale, TranslationDictionary> = {
  en: {
    ...
    modalSubtitle: "used4cash eliminates the friction of selling your electronics. No haggling, no scams, just data-driven payouts.",
  ...
  fr: {
    ...
    modalSubtitle: "used4cash élimine les frictions liées à la vente de vos appareils électroniques. Pas de marchandage, pas d'arnaques, juste des paiements basés sur les données.",
  ...
  es: {
    ...
    modalSubtitle: "used4cash elimina la fricción de vender tu electrónica. Sin regateos, sin estafas, solo pagos basados en datos.",
  ...
  pt: {
    ...
    modalSubtitle: "used4cash elimina o atrito de vender seus eletrônicos. Sem pechinchar, sem golpes, apenas pagamentos baseados em dados.",
  ...
  ar: {
    ...
    modalSubtitle: "يقضي used4cash على صعوبات بيع أجهزتك الإلكترونية. لا مساومات، لا عمليات احتيال، بل مدفوعات دقيقة بناءً على البيانات.",
